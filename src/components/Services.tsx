export default function Services() {
  const services = [
    ...
    },
    {
      ...
      description: "Leading institutional expansion across UAE/MENA with deep relationships across banks, financial institutions, and regulatory bodies.",
        ...
        <div className="mt-6 text-center">
          <div className="inline-block px-4 py-2 border border-border bg-secondary river-border-top">
            <p className="text-xs text-text-muted">
              <span className="text-white font-medium">Specialization:</span> Fintech, Payments, AI, and Emerging Technologies
            </p>
          </div>
        </div>
      </div>
